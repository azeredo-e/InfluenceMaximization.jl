...
# ╔═╡ f7483e70-651d-11f1-9d60-9bc10df94b9d
begin
	using Printf
	using Random
	using Distributions
	...
	include("../src/InfluenceMaximization.jl")
	using .InfluenceMaximization
end


# ╔═╡ 6e735ba2-6fde-48a1-be72-76425f058821
begin
	using Plots, GraphRecipes
	using BenchmarkTools
end

# ╔═╡ fab87f07-03da-4fe0-a61d-242322684a0e
md"""
# InfluenceMaximization.jl Algorithms Demo
"""

# ╔═╡ f996cbad-56a4-43c9-8b99-010b12609a70
begin
    edge_weights = Dict()
	g = SimpleWeightedDiGraph(5)
    add_edge!(g, 5, 3, 0.4); edge_weights[(5, 3)] = 0.4
    add_edge!(g, 3, 1, 0.2); edge_weights[(3, 1)] = 0.2
    add_edge!(g, 3, 2, 0.1); edge_weights[(3, 2)] = 0.1
    add_edge!(g, 1, 2, 0.3); edge_weights[(1, 2)] = 0.3
    add_edge!(g, 2, 4, 0.2); edge_weights[(2, 4)] = 0.2
    add_edge!(g, 4, 2, 0.4); edge_weights[(4, 2)] = 0.4
...
# ╔═╡ cf2b9dee-7255-4664-ac2c-4ef86aabf240
md"""
## Algorithms
...
celf(g, 2; n_iters=N_ITERS, verbose = true)

# ╔═╡ ba113cf5-90ee-47a2-97b1-b301aaa9ced1
@benchmark celf(g, 2; n_iters=N_ITERS)

# ╔═╡ be86dfaa-52d5-4641-83bc-4f6fd85ac8d7
md"""
### CELF++
"""

# ╔═╡ a9f7d338-7901-4047-974a-e55f08b0e690
celfpp(g, 2; n_iters=N_ITERS)

# ╔═╡ e1b0f36f-a075-4634-86b4-9a75bb1443a8
@benchmark celfpp(g, 2; n_iters=N_ITERS, show_results=false)

# ╔═╡ 9480b632-fe3b-4256-9a27-c550ebe4ca88
md"""
### Greedy
"""

# ╔═╡ dd5e729d-6474-4664-a31a-2348c430f934
greedy(g, 2; n_iters=N_ITERS)

# ╔═╡ 68f2bceb-6217-484e-89f7-7bff78832eaf
@benchmark greedy(g, 2; n_iters=N_ITERS)

# ╔═╡ b59beaac-801f-486a-884e-c97786bc0889
md"""
### SelectTopK
"""

# ╔═╡ 0429a851-ad6e-4585-9c20-22bc02ae6f83
select_top_k(g, 2; n_iters=N_ITERS)

# ╔═╡ 22280e77-14ea-4458-8039-d38c6680c9f3
@benchmark select_top_k(g, 2; n_iters=N_ITERS)

# ╔═╡ 47a3e29a-e608-4155-942e-8af1db5bf10c
md"""
### RankedReplace
"""

# ╔═╡ 34936995-e706-46c3-85f0-cf89ddac2ad9
ranked_replace(g, 2; n_iters=N_ITERS)

# ╔═╡ ac6bc7f8-43e8-4ead-a90d-2f63a0f0d8dd
@benchmark ranked_replace(g, 2; n_iters=N_ITERS)
...
manifest_format = "2.0"
project_hash = "2dcc62fb397a8cc3a85d4f2081c3ffc0117aaa3a"
